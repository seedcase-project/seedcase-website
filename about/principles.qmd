...
The values and principles are ever evolving, that we will update and
refine as we learn and grow.
...
-   Work that is visible and open is easier to participate in and
    contribute to
-   Code itself is as valuable as working software
...
-   design documentation, training material, and software for people who
    are not computationally technical
-   incorporate accessibility in all our output, to be more inclusive
