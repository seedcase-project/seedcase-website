...
# installed. Follow the instructions in `community/contribute/index.qmd`.
# 
# Usage:
#
...
then
  ...
  echo "PlantUML doesn't exist. Please follow install instructions in community/contribute/index.qmd"
fi
