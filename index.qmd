...
```{r fig-dd2-description}
#| echo: false
#| fig.cap: "Summary of the different DD2 databases."
knitr::include_graphics("images/dd2-description.svg")
```
...
```{r fig-detailed-schematic}
#| echo: false
#| fig.cap: "Detailed schematic of the data infrastructure framework."
knitr::include_graphics("images/detailed-schematic.svg")
```
...
-   **Git, GitLab, and DVC for version control:** Formal version control
    ...
    standard practice in software engineering. After Git was developed,
    it has increasingly been used by researchers across scientific
    fields to improve research transparency and openness. GitLab is an
    open source product to host Git projects and handles many modern
    software development tasks. DVC, or Data Version Control, is a
    machine learning VC software for data and models that integrates
    with Git.
...
```{r fig-gantt-chart, echo=FALSE}
#| fig.cap = "Gantt chart of deliverables and timelines.",
#| out.width = "100%",
#| out.height = "1100px"
knitr::include_graphics("images/gantt-chart.svg")
```
