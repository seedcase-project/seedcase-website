...
::: callout-tip
For a more detailed and regularly updated roadmap, see our
[GitHub Roadmap](https://github.com/orgs/seedcase-project/projects/22/views/1).
:::
...
Some of these products are not strictly software (e.g., templates), but
are designed to work within software environments, integrate with other
workflows, or support research software and data engineering.

::: callout-note
To make our tools easier to get started with for novices and experts
alike, we put a strong emphasis on documentation. Our software and
software-related products generally include documentation on design
decisions, usage patterns, and an API reference.
:::
...
- [Health in Central
  Denmark Region](https://www.stenoaarhus.dk/forskning/helbred-i-midt/)
