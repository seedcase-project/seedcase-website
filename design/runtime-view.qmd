...
## Exploring metadata and requesting data

We envision that there are two main ways to apply for data from a Data
Resource using Seedcase to manage their data. The first will be through
