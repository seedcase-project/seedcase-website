...
-   not go into detail on database, frontend, nor api design
-   not go into detail on security

## Types of (expected) data being entered

## How/frequency of data being input
...
Questions:
  ...
  - Do some basic QA/QC before data input? How?
  - 
-->
```
