...
1.  **User 1**: Those *inputting data* into the Data Resource, e.g.,
...
2.  **User 2**: Those *requesting access* to a subset of data in the
    Data Resource, e.g., researchers and clinicians. Use cases are:
    ...
    2.  Researchers request access to data by submitting a description
        ...
        from the catalogue. This request is sent to a list of data
        projects to await approval from the data controllers (User 4).
3.  **User 3**: Those *viewing updates on findings and results* from the
...
4.  **User 4**: Administrators and data controllers of the Data
