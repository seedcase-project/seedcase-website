...
are several design styles available for building APIs, including REST,
SOAP, and GraphQL.

## Decision

We will use the REST (Representational State Transfer) architectural
style for implementing the communication protocol between our client and
server components, instead of SOAP (Simple Object Access Protocol) or
GraphQL.
...
SOAP is a widely used technology for implementing web services. SOAP is
...
GraphQL is an increasingly popular technology for building web APIs.
...
make it a better choice for our client-server communication needs.
