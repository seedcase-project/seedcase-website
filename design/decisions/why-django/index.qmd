...
All considered web frameworks use Python. For our decision on using Python, see the page [Why Python](https://seedcase-project.org/design/decisions/why-python/).
