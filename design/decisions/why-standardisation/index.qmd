...
We hope to use the project pages to track the issues that are being worked on each month (sprint), and to some degree use it to move issues between people associated with the project, so that we all know who is working on what and when.

<!--TODO We should have a discussion on this soon-->
