...
- Tracking project management: Looking over the 
...
- Already splitting projects into other repos
- Open source projects are usually a "one-repo is one-product/output" format (e.g. R or Python package). Contributors will be 
- We are starting to and will be 
...
We decided on THIS because of THAT.
