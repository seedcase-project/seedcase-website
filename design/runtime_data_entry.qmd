...
There are two ways of adding data to a seedcase Data Resource, the
first is automated batch file uploads where a file (eg. csv, xls, txt)
is uploaded by the administrator or a trusted user. In either case it
will be the administrator who will be doing the initial upload, as that
will entail setting up tables and allocating space in the raw data file
storage. The second way of getting data into the Data Resource is by manual
entering by an approved member of staff.
