...
| Incorporate "Test/Doc-Driven Development" styles | Each has pros and cons, we use what works best. See the [Contributing Guidelines](https://community.seedcase-project.org).                  |
