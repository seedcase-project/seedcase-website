...
License](/design/decisions/why-license/) 
for more
...
transparent, rigorous, and FAIR is keeping a changelog and tracking
versions.
...
data later on based on the FAIR principles. A part of FAIR data is
