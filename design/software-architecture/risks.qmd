...
As discussed under [Architecture Decisions](https://seedcase-project.org/design/software-architecture/architecture-decisions), we have chosen to use Django, PostgreSQL, and Docker for the Seedcase Product. Even though we have deemed these technologies the most suitable the product, they include technical debt and risks, which will be discussed below.
