...
2. _Map the data input sources and formats from the various collection centers._
...
standard DST format.  
3. _Move as much data as possible to a central location._ All data will be
...
PhD and Alisa Kjærgaard,
MD, PhD. A project group
...
3. Thoughts on converting this into an
...
read about it. 
 6. When we get funding, how to limit new personnel from the
